...
<div class="ml-64 min-h-screen bg-white">
    <div class="p-8">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-800 mb-2">Selamat Datang, <?php echo $_SESSION['nama'] ?? 'Ketua'; ?></h1>
            <p class="text-gray-600 text-lg">Kelola data warga dan wilayah dengan mudah</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                <a href="Manage/manage_warga.php" class="group flex flex-col items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 transform hover:scale-105">
                ...
                <a href="Manage/manage_kk.php" class="group flex flex-col items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-green-300 hover:shadow-md transition-all duration-200 transform hover:scale-105">
                ...
                <a href="laporan.php" class="group flex flex-col items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-red-300 hover:shadow-md transition-all duration-200 transform hover:scale-105">
                ...
                <a href="pengumuman.php" class="group flex flex-col items-center p-4 bg-white rounded-xl border border-gray-200 hover:border-indigo-300 hover:shadow-md transition-all duration-200 transform hover:scale-105">
