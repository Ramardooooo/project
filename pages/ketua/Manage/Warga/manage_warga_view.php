            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100/50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">KK</th>
                ...
                <tbody class="divide-y divide-gray-100/50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600"><?php echo isset($warga['kk_id']) && $warga['kk_id'] ? htmlspecialchars($warga['kepala_keluaraga'] . ' (' . $warga['no_kk'] . ')') : '-'; ?></td>
